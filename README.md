...
* itemdata/items.js - (a JSON-like file) holds all item data, including the tags used when searching/filtering
* itemdata/aliases.js - a hand-edited thesaurus for tags
